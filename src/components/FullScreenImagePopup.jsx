      ...
      {props.display && (
        <div className="z-40 fixed top-0 left-0 w-screen h-screen bg-gray-900 bg-opacity-80 flex flex-col items-center justify-center">
          <div className="w-full h-full flex flex-row items-center justify-center p-4">
            ...
            <div className={fullScreenImageLoading ? "block" : "hidden"}>
            ...
            <img
              ...
              className={
                (fullScreenImageLoading ? "hidden" : "block") +
            ...
            <button
              className="fixed top-10 right-10 bg-gray-900 bg-opacity-80 text-gray-100 rounded-full p-2"
              onClick={() => {
