...
import { getNowPlayingMovies, getGenres } from "../api/movies";
...
export default class NowPLaying extends Component {
  constructor(props) {
    ...
    this.fetchNowPlayingMovies = this.fetchNowPlayingMovies.bind(this);
  ...
  nextPage = () => {
    window.location.href = `/nowplaying/${this.state.currentPage + 1}`;
  };
